...
export function PreviewFooterSummary({ summary }: { summary: ChangeSummary | null }) {
  return (
    <div className="shrink-0 border-t border-white/8 px-5 py-4">
      {summary ? (
        <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs text-sand-200/78">
        ...
        <div className="text-sm text-sand-200/62">
